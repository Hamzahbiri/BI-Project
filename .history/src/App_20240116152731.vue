...
export default {
  ...
  methods: {
    updateChart() {
  console.log('Updating chart with filter:', this.filterTerm);
  ...
  if (this.$refs.myChart.chart) {
    console.log('Updating myChart');
    this.$refs.myChart.chart.data = filteredData;
    this.$refs.myChart.chart.update();
  }

  if (this.$refs.myChart2.chart) {
    console.log('Updating myChart2');
    this.$refs.myChart2.chart.data = filteredData;
    this.$refs.myChart2.chart.update();
  }
},
