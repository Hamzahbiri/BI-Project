...
<div class="box">
 ...
 <div class="box2">
      ...
      <label for="filterInput" class="form-label">Filter Data:</label>
      <input type="text" id="filterInput" v-model="filterTerm" @input="updateChart" class="form-control" placeholder="Enter a month to filter"/>
