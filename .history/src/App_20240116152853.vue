...
export default {
  ...
  methods: {
    createCharts() {
      this.myChart = this.createChartInstance('myChart', 'line');
      this.myChart2 = this.createChartInstance('myChart2', 'bar');
    },
    createChartInstance(ref, type) {
    ...
    updateChart() {
      ...
      this.updateChartData(this.myChart, filteredData);
      this.updateChartData(this.myChart2, filteredData);
    },
