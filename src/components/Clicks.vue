...
const data=",clicks;C1,110;C2,180;C3,30;C4,140;";
const GetData=async()=>{
await axios.get("https://localhost:7056/api/getByCampaign?measures=Clicks")
.then((res) => {
  console.log(res);
})
