<template>
  <div class="container ms-5">
    <h3 class="display-5">Total spent</h3>
    <router-link to="/">
...
const data=",Total spent;C1,3120;C2,2005;C3,4309;C4,6720;";
const GetData=async()=>{
await axios.get("https://localhost:7056/api/getByCampaign?measures=*")
.then((res) => {
  console.log(res);
})
