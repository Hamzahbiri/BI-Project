<template>
    ...
    <table>
      ...
      <div class="card">
        ...
        <router-link :to="{name: 'views'}" class="btn btn-dark ms-4">Go to Views
            </router-link>
      ...
      <div class="card">
        <div class="card-body">
          <img src="https://cdn1.iconfinder.com/data/icons/aami-flat-emails/64/email-19-512.png"
                 alt="Eye Image"
                 width="40"
                 height="40">
          <div class="card-content">
        ...
        <router-link :to="{name: 'Clicks'}" class="btn btn-dark ms-4">Go to Clicks
            </router-link>
      ...
      <div class="card">
        <div class="card-body">
          <img src="https://www.vhv.rs/dpng/d/186-1864442_local-social-media-icon-hd-png-download.png"
                 alt="Eye Image"
                 width="40"
                 height="40">
          <div class="card-content">
        ...
        <router-link :to="{name: 'Visited'}" class="btn btn-dark ms-4">Go to Visited
            </router-link>
      </div>
    </div>
      ...
      <div class="card">
        <div class="card-body">
          <img src="https://lyfeaccounting.com/wp-content/uploads/2020/08/revenue-and-expenses-icon.png"
                 alt="Eye Image"
                 width="40"
                 height="40">
          <div class="card-content">
        ...
        <router-link :to="{name: 'Totalspent'}" class="btn btn-dark ms-4">Go to Total Spent
            </router-link>      
      </div>
    </div>
